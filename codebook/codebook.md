...
> Bundestag (2026), _Stammdaten aller Abgeordneten seit 1949 im XML-Format_, version: 2026-04-29. https://www.bundestag.de/services/opendata
...
## Data frame `namen`
`namen` contains 4901 observations from 4614 members of the Bundestag. It includes 10 variables:
...
## Data frame `bio`
`bio` contains 4614 observations from 4614 members of the Bundestag. It includes 12 variables:
...
## Data frame `wp`
`wp` contains 13046 observations from 4614 members of the Bundestag. It includes 9 variables:
...
## Data frame `inst`
`inst` contains 16955 observations from 4614 members of the Bundestag. It includes 9 variables:
